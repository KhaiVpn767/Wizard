...
function pasang_ssl() {
    ...
    curl https://raw.githubusercontent.com/KhaiVpn767/Wizard/main/acme.sh -o /root/.acme.sh/acme.sh
...
function install_xray(){
    ...
    xraycore_link="https://github.com/KhaiVpn767/Xcore-custompath/releases/download/Xray-linux-64-v1.6.5.1/Xray-linux-64-v1.6.5.1"
